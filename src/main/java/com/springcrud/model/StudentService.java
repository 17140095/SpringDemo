...
public class StudentService {
    ...
    public Student getById(Long studentId) {
        ...
        if (student.isPresent()) {
            ...
            throw new IllegalStateException("Student of id " + studentId + " not found");
        }
    }
    public Student deleteStudent(Long studentId) {
        ...
        if (toDelete.isPresent()) {
            ...
            throw new IllegalStateException("No model found of this "+studentId+" ID.");
        }
    }

    public Student addStudent(Student student) {
        if (this.repository.findStudentByEmail(student.getEmail()).isPresent()) {
            throw new IllegalStateException("This model is already exist");
        } else {
            return this.repository.save(student);
        }
    }

    public Student updateStudent(long studentId, Student toUpdate) {
       ...
       if (optionalStudent.isPresent()) {
           ...
           throw new IllegalStateException("Student of id " + studentId + " not exist");
       }
    }
}
